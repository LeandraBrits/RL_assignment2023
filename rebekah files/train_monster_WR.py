...
if __name__ == '__main__':
  ...
  #  env = RenderRGB(env, "pixel_crop")
    ...
    torch.save(agent.Q_current.state_dict(), "dqn_monster_WR.pth")
    ...
    plt.savefig("dqn_monster_WR_re_graph.png")
    #plt.show()
    ...
    plt.xlabel("Episodes")
    plt.ylabel("Loss")
    plt.savefig("dqn_monster_WR_loss_graph.png")
    #plt.show()
    np.save("monster_WR_reward_array.npy",episode_rewards)
    np.save("monster_WR_loss_array.npy",episode_loss)
    agent.save("monster_WR_dqn")
