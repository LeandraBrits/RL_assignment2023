...
if __name__ == '__main__':
  ...
  #  env = RenderRGB(env, "pixel_crop")
    ...
    torch.save(agent.Q_current.state_dict(), "dqn_Room-Monster.pth")
    plt.figure()
    ...
    plt.show()
    np.save("reward_array.npy",episode_rewards)
    np.save("loss_array.npy",episode_loss)
    agent.save("lava_dqn")
