...
if __name__ == '__main__':
    ...
    hyper_params = {
        ...
        "env-name": "MiniHack-MazeWalk-15x15-v0",  # name of the game
  ...
  #  env = RenderRGB(env, "pixel_crop")
    ...
    torch.save(agent.Q_current.state_dict(), "dqn_maze_NR.pth")
    ...
    plt.savefig("dqn_maze_NR_re_graph.png")
    #plt.show()
    ...
    plt.xlabel("Episodes")
    plt.ylabel("Loss")
    plt.savefig("dqn_maze_NR_loss_graph.png")
    #plt.show()
    np.save("maze_NR_reward_array.npy",episode_rewards)
    np.save("maze_NR_loss_array.npy",episode_loss)
    agent.save("maze_NR_dqn")
