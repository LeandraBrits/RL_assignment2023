...
if __name__ == '__main__':
  ...
  #  env = RenderRGB(env, "pixel_crop")
    ...
    torch.save(agent.Q_current.state_dict(), "dqn_lava_WR.pth")
    ...
    plt.savefig("dqn_lava_WR_re_graph.png")
    #plt.show()
    ...
    plt.xlabel("Episodes")
    plt.ylabel("Loss")
    plt.savefig("dqn_lava_WR_loss_graph.png")
    #plt.show()
    np.save("lava_WR_reward_array.npy",episode_rewards)
    np.save("lava_WR_loss_array.npy",episode_loss)
    agent.save("lava_WR_dqn")
