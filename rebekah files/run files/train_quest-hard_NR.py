...
if __name__ == '__main__':
  ...
  #  env = RenderRGB(env, "pixel_crop")
    ...
    torch.save(agent.Q_current.state_dict(), "dqn_quest_NR.pth")
    ...
    plt.savefig("dqn_quest_NR_re_graph.png")
    #plt.show()
    ...
    plt.xlabel("Episodes")
    plt.ylabel("Loss")
    plt.savefig("dqn_quest_NR_loss_graph.png")
    #plt.show()
    np.save("quest_NR_reward_array.npy",episode_rewards)
    np.save("quest_NR_loss_array.npy",episode_loss)
    agent.save("quest_NR_dqn")
