...
torch.save(PG_agent.policy.state_dict(), "reinf_monster_NR.pth")
env.close()
...
plt.savefig("reinf_monster_NR_re_graph.png")
#plt.show()
...
plt.xlabel("Episodes")
plt.ylabel("Loss")
plt.savefig("reinf_monster_NR_loss_graph.png")
#plt.show()

np.save("reinf_monster_NR_reward_array.npy",ep_reward)
np.save("reinf_monster_NR_loss_array.npy",ep_loss)