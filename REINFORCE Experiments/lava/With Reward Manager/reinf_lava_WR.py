...
torch.save(PG_agent.policy.state_dict(), "reinf_lava_WR_added.pth")
env.close()
...
plt.savefig("reinf_lava_WR_added_re_graph.png")
#plt.show()
...
plt.xlabel("Episodes")
plt.ylabel("Loss")
plt.savefig("reinf_lava_WR_added_loss_graph.png")
#plt.show()

np.save("reinf_lava_WR_added_reward_array.npy",ep_reward)
np.save("reinf_lava_WR_added_loss_array.npy",ep_loss)